...
VALUES  (1, 'root', 'Password', 'root@community.com'),
        (2, 'Devinwhite', 'Password1', 'devin.white1@marist.edu'),
        (3, 'BrianLynch', 'Password2', 'Brian.Lynch1@marist.edu'),
        (4, 'AnthonyDamico', 'Password3', 'Anthony.Damico1@marist.edu'),
        (5, 'ZachFreedman', 'Password4', 'Zach.Freedman1@marist.edu'),
        (6, 'DylanBrightman', 'Password5', 'Dylan.Brightman1@marist.edu'),
        (7, 'skyna-', 'Password6', 'skyna-@hotmail.net'),
        (8, 'mr68w', 'Password7', 'mr68w@gmail.com'),
        (9, 'PhuckSJWs', 'Password8', 'PhuckSJWs@irs.gov'),
        (10, 'rockyxhardy', 'OogaBooga', 'rockyxhardy@duolingo.com'),
        (11, 'IrishGrouch24', 'Password10', 'IrishGrouch24@Guinness.com'),
        (12, 'JoresV', 'Password11', 'JoresV@phizer.net'),
        (13, "DekMelU", 'Password12', 'DekMelU@optonline.net'),
        (14, 'DianaMuscle', 'Password13', 'DianaMuscle@p90x.com');
...
Tony Stark, I think… and I remember Captain America getting real old and retiring after time-travel stuff so I guess he is dead too? Anyone else?', '2021-10-13', 20, 6),
        ...
        (4, 1, "Adam Warlock vs Captain Marvel", "As you know, it is already known who will be the actor who will give life to the character of Adam, who do you think would win?", "2021-10-14", 1, 2),
        (5, 1, "What were Thor's last words to Loki", "I heard people said It was 'You really are the worst brother', but I don't see him say that in Infinity War or Thor Ragnarok.", '2021-10-14', 11, 68),
        (6, 1, 'MCU "STRONGEST AVENGER" list', 'Also, lets break down who is eligible for this:
...
(CommentID, PostID_Comment, Comment, CommentDate, CommentVotes, CommenterID, CommentTags)
...
Then, after that sales channel, it comes to subscription streaming services.", "2021-10-11", 0, 4, null),
        ...
        (6, 1, "it's been killing the box office and has been one of the few films to have some staying power in theaters during the pandemic.", "2021-10-11", 0, 8, 'Pandemic'),
        (7, 1, "Eternals is being released November 5", "2021-10-11", 1, 5, null),
        ...
        (10, 2, "I think that’s pretty accurate. I think the MCU not having access to hardly any of your A listers was a good thing for them. They laid down a solid foundation for the MCU with a B list appetizer Now we get our A list main course.", "2021-10-13", 10, 6, null),
        ...
        (15, 2, "Depends on the era. The FF from 1961 to the late 70s was definitely the premier team book at Marvel until Claremont took over the X-Men. Avengers I'd agree were C-listers for most of their existence until Bendis started writing them in the mid-2000s.", "2021-10-13", 2, 6, null),
        (16, 2, "That run inserted two A-Listers (Spider-Man & Wolverine).", "2021-10-13", 2, 5, null),
        (17, 2, "Yep, that's true, I forgot about that.", "2021-10-13", 1, 2, null),
        ...
        (20, 3, "Natasha is dead as of End Game as well. Steve isn't dead just retired", "2021-10-13", 2, 4, null),
        (21, 3, "Didn’t Far From Home say that he was dead?", "2021-10-13", 0, 3, null),
	(22, 3, "hmm, im not sure.", "2021-10-13", 0, 5, null),
        ...
        (24, 3, "In falcon and winter solider’s museum scene we seen on one of the pillars of words that it says that Steve has “retired”. This means that the public story is that he has simply retired, it makes no mention of him becoming an old man so presumably the public don’t know about that.", "2021-10-13", 0, 3, null),
        (25, 3, "Tony, Cap, Black Widow and Gamora are all deceased. Cap isn’t technically confirmed dead, but it’s heavily implied. There’s a chance Old Man Steve could come back.", "2021-10-13", 7, 4, null),
        (26, 3, "I love that Abraham Lincoln is in there Edit: just so this isn't misinterpreted, I just find it funny he was listed when he hasn't appeared in the MCU (unless I missed something)", "2021-10-13", 2, 5, null),
        (27, 3, "His portrait appeared in Agents of SHIELD.", "2021-10-13", 0, 6, null),
        (28, 3, "Widow, died for the soul stone. Iron man,dead, died from snapping. Steve Rogers, retired. Loki, dead, strangled by thanos. Gamora from Guardians1-2, dead, also died for the soul stone. quicksilver, dead, shot by ultron. Tchalla, written out. Vision, dead? Maria Rambeau,dead.", "2021-10-13", 6, 8, 'helpful'),
        (29, 4, "Honestly for the MCU only it’ll probably be a stalemate", "2021-10-13", 0, 4, null),
        (30, 4, "See at this point they should keep the original premises of Adams origin, but not before they introduce the FF and the High Evolutionary. They really need to bring on the Fantastic Four!", "2021-10-13", 0, 1, null),
        (31, 4, "Adam Warlock is a much much more powerful character than Captain Marvel.", "2021-10-14", 1, 8, null),
        (32, 5, "He says it in Infinity War right after Loki unveils he took the Tesseract. This was before he got metal gagged by Ebony Maw.", "2021-10-14", 0, 5, null),
        (33, 5, "It was in the beginning of Infinity war when Thanos is speaking to Loki.", "2021-10-14", 0, 6, null),
        (34, 5, "You're really the worst, brother", "2021-10-14", 1, 6, null),
        (35, 5, "let me YouTube that for you", "2021-10-14", 0, 7, null),
        (36, 6, "If we’re just picking one then I would say Captain Marvel", "2021-10-14", 7, 10, 'CaptianMarvel'),
        (37, 6, "I ment a list; Not just one person. That I agree she is a HIGH contender for the number one spot.", "2021-10-14", 0, 4, null),
        (38, 6, "Oh okay. At the top of the post it says one is the strongest. I thought you were asking. My bad.", "2021-10-14", 0, 10, null),
        (39, 6, "Cleared it up", "2021-10-14", 0, 4, null),
        (40, 6, "Scarlet Witch, Captain marvel, Doc strange, Thor, Iron man, If it was after infinity war I'd have put thor in first, but they nerfed him a lot in endgame", "2021-10-14", 3, 5, 'top5'),
        (41, 6, "Big Iron Man fan here but Iron Man is actually one of the weakest. His latest armor isnt even that great.", "2021-10-14", 2, 3, 'IronMan'),
        (42, 6, "Iron Man’s armor was one of the few things to make Thanos bleed. Not saying he’s one of the strongest with it on but you’re underestimating how powerful it is. Captain Marvel, Scarlet Witch, and Thor are the top 3 though.", "2021-10-14", 5, 11, "Top3"),
        (43, 6, "It cut him. Stormbreaker fucking murdered him. Give Hawkeye a bow made of paper and he can problably cut Thanos too. Captain Marvel, Scarlet Witch, and Thor are the top 3 though. Probably. with Thor BARELY hanging in that Top 3 though....Subsititue him with someone else and I might not argue.", "2021-10-14", 2, 3, null),
        (44, 6, "Yea I think Doc strange takes 3rd, his power level has presumably not changed since infinity war. Thor is my favourite character, but they fucked him up.", "2021-10-14", 1, 12, 'DoctorStrange'),
        (45, 6, "Forgot about Strange, correct.", "2021-10-14", 0, 3, 'DoctorStrange'),
        (46, 6, "I find that the 3 that are often talked about (Wanda, Danvers, Strange) peak in their own ways. Wanda: Highest non-AoE destructive power. Danvers: All-rounder + physical strength. Strange (technically not an Avenger): Most versatile", "2021-10-14", 5, 6, 'Top3'),
        (47, 6, "Strange (technically not an Avenger) Danvers is? Neither officially are. Then again when Rogers says Assemble you can count them in.... Comic wise (since MCU neither confirms nor denies) they are or were members.", "2021-10-14", 1, 3, null),
        (48, 6, "Danvers has more weight since she joined the others to kill farmer Thanos and liaised operations with Romanoff in the 5 year time gap", "2021-10-14", 2, 13, "CaptianMarvel"),
        (49, 6, "Unbeatable tier
...
Falcon - No superpowers to speak of, and all he has is carbon-fiber wings and special goggles. Better step his game up if he's the new Captain America.", "2021-10-14", 12, 9, "tierlist"),
        (50, 6, "Gamora - A green Black Widow and an estranged daughter of Thanos. Could easily beat Black Widow in a fight, don't @ me. OH SHIT. YOU FUCKED UP NOW. Im not tackling this one... Black Widow - She ran at Thanos with a taser. Has no superpowers, just hand-to-hand skills. Almost got taken down by Ant-Man. I actually thought this too. But she has actually been experiemented on and is enhanced (besides comic, implied in Age Of Ultron). Besides hand-to-hand skills a EXPERT strategist (just like Cap)", "2021-10-14", 1, 3, null),
        (51, 6, 'Hulk “Voiceprint authorization required” “Banner.” ”Welcome, Strongest Avenger” “Uhhhhhh, what?”', "2021-10-14", 0, 2, "Hulk"),
        (52, 6, "Captain Marvel!", "2021-10-14", 0, 14, "CaptianMarvel"),
        (53, 6, "People are so hung up on strength that they overlook the other things that make a character “strong” in the MCU. These types of discussions just turn into talk about strength. As if skills, fighting ability, brains, charisma, leadership ability etc. don’t matter. You can be the strongest but a horrible strategist, fighter and planner.", "2021-10-14", 3, 4, null),
        (54, 6, "My top 3 would be: Scarlet Witch, especially if she gets her reality based powers according to the latest rumours. Captain Marvel. Doctor Strange", "2021-10-14", 5, 8, "Top3"),
        (55, 6, "Unpopular opinion: Tony Fucking Stark. When having all infinity stones, Thanos was hurting and Hulk was all transitional Steve, but Tony (a mere human) didn't even flinch.", "2021-10-14", 1, 9, "ironman"),
        (56, 6, "Flinched? He died.", "2021-10-14", 0, 3, null),
        (57, 6, "Yeah, later.", "2021-10-14", 0, 9, null),
        (58, 6, "And none of those died lol.... Stark is extremely weak. One of my favorite characters still but so weak. Cap destroyed him (which hurt to see but)", "2021-10-14", 0, 3, "ironman");
