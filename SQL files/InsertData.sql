...
VALUES  ('Devinwhite', 'Password1', 'devin.white1@marist.edu'),
        ('BrianLynch', 'Password2', 'Brian.Lynch1@marist.edu'),
        ('AnthonyDamico', 'Password3', 'Anthony.Damico1@marist.edu'),
        ('ZachFreedman', 'Password4', 'Zach.Freedman1@marist.edu'),
        ('DylanBrightman', 'Password5', 'Dylan.Brightman1@marist.edu');

INSERT INTO Category_tbl
(CategoryName, CategoryVotes)
VALUES('Marvel', 2000000),
      ('League of Legends', 5400000);

SELECT * FROM Category_tbl;

INSERT INTO Post_tbl
(CategoryID_Post, PostTitle, PostBody, PostDate, PostVotes, Creator)
VALUES  (1, 'Why is Shang Chi Disney Plus release date November 11th, when they said only 45 Days of Exclusivity?', 
'The movie came out September 3rd. Thats more like 70 days ?',"2021-10-11", 1, 'kristijan1001'),
...
Then, after that sales channel, it comes to subscription streaming services.", "2021-10-11", 0, 4, null),
        ...
        (1, "it's been killing the box office and has been one of the few films to have some staying power in theaters during the pandemic.", "2021-10-11", 0, 1, 'Pandemic'),
        (1, "Eternals is being released November 5", "2021-10-11", 1, 1, null),
        ...
        (2, "I think that’s pretty accurate. I think the MCU not having access to hardly any of your A listers was a good thing for them. They laid down a solid foundation for the MCU with a B list appetizer Now we get our A list main course.", "2021-10-13", 10, 1, null),
        ...
        (2, "Depends on the era. The FF from 1961 to the late 70s was definitely the premier team book at Marvel until Claremont took over the X-Men. Avengers I'd agree were C-listers for most of their existence until Bendis started writing them in the mid-2000s.", "2021-10-13", 2, 1, null),
        (2, "That run inserted two A-Listers (Spider-Man & Wolverine).", "2021-10-13", 2, 5, null),
        (2, "Yep, that's true, I forgot about that.", "2021-10-13", 1, 1, null),
