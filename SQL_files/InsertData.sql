...
'The movie came out September 3rd. Thats more like 70 days ?',"2021-10-11", 1, 7),
...
After watching what feels like a dozen movies over the last several years (some out of order) and with the time-travel shenanigans, multiverses, the Snap and Blip, and fact that the films themselves are set in different “time periods” of the MCU, I don’t know which heroes are dead and which aren’t as of “present day” MCU.
Tony Stark, I think… and I remember Captain America getting real old and retiring after time-travel stuff so I guess he is dead too? Anyone else?', '2021-10-13', 20, 17),
        (1, "Adam Warlock vs Captain Marvel", "As you know, it is already known who will be the actor who will give life to the character of Adam, who do you think would win?", "2021-10-14", 1, 18),
        (1, "What were Thor's last words to Loki", "I heard people said It was 'You really are the worst brother', but I don't see him say that in Infinity War or Thor Ragnarok.", '2021-10-14', 11, 24),
...
Thanks in advance.", "2021-10-20", 3, 2),
        ...
        (3, 'More than 100 San Francisco first responders remain unvaccinated and could lose jobs', 'https://www.sfchronicle.com/sf/article/More-than-100-San-Francisco-police-and-16532932.php?sid=5d54065e91d15c7b08162233&utm_source=newsletter&utm_medium=email&utm_content=headlines&utm_campaign=sfc_morningfix', "2021-10-20", 24, 6),
        (3, 'U.S. Coal Use Is Rebounding Under Biden Like It Never Did With Trump', 'https://www.bloomberg.com/news/articles/2021-10-12/u-s-coal-use-rebounds-under-biden-as-energy-crisis-drives-fossil-fuel-demand', "2021-10-20", 19, 3),
        (3, 'Youngkin vows to hold Loudoun County officials responsible after alleged sexual assaults', 'https://www.foxnews.com/politics/youngkin-vows-to-hold-loudoun-county-officials-responsible-after-alleged-sexual-assaults', "2021-10-20", 8, 14),
        (3, "Aaron Rodgers has a big problem with 'woke cancel culture", 'https://nypost.com/2021/10/19/aaron-rodgers-has-a-big-problem-with-woke-cancel-culture/?utm_source=reddit.com', "2021-10-20", 3, 4),
...
What other examples are out there?', "2021-10-20", 14, 10),
        ...
        (5, 'Study: Fossil fuel plans would far overshoot climate goals', 'https://apnews.com/article/climate-science-business-environment-europe-dcbcc6388b24c8b83476ddea14b92e21', "2021-10-20", 9, 7),
        (5, 'Google Play Store will soon show you how much apps know about you', 'https://www.techradar.com/news/google-play-store-will-soon-show-you-how-much-apps-know-about-you', "2021-10-20", 23, 6),
        (5, 'Facebook plans to soon rebrand with a new name', 'https://www.marketwatch.com/story/facebook-plans-to-soon-rebrand-with-a-new-name-report-11634701715?mod=home-page', "2021-10-20", 17, 5),
        (5, "The CFO's Guide to Ransomware Risk Mitigation", 'https://accelerationeconomy.com/cyber-security/the-cfos-guide-to-ransomware-risk-mitigation/', "2021-10-20", 9, 4),
        (5, 'Wearable Microphone Jamming', 'http://sandlab.cs.uchicago.edu/jammer/', "2021-10-20", 37, 3),
        (5, 'Teen Girls Are Developing Tics. Doctors Say TikTok Could Be a Factor.', 'https://www.wsj.com/articles/teen-girls-are-developing-tics-doctors-say-tiktok-could-be-a-factor-11634389201?mod=e2tw', "2021-10-20", 21, 2),
